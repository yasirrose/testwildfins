...
<!---ML ZONES START--->
<cfquery name="getML_Start" datasource="#Application.dsn#">
    SELECT TOP 1
        dbo.PROJECTS.[Date],
        dbo.TLU_Zones.[ZONE]
    FROM  dbo.PROJECTS
...
<cfquery name="getML_End" datasource="#Application.dsn#">
    SELECT TOP 1
        dbo.PROJECTS.[Date],
        dbo.TLU_Zones.[ZONE]
    FROM
...
<cfquery name="getIR_Start" datasource="#Application.dsn#">
    SELECT TOP 1
        dbo.PROJECTS.[Date],
        dbo.TLU_Zones.[ZONE]
    FROM
...
<cfquery name="getIR_End" datasource="#Application.dsn#">
    SELECT TOP 1
        dbo.PROJECTS.[Date],
        dbo.TLU_Zones.[ZONE]
    FROM

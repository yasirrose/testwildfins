...
<!--- loop through query --->
		<cfloop query="getdolphin">
			...
			<cfset structofdolphin["DScoreDate"] = DateFormat(getdolphin.DScoreDate, "YYYY-MM-DD")>
			<cfset structofdolphin["DistinctDate"] = DateFormat(getdolphin.DistinctDate, "YYYY-MM-DD")>
	...
	<cffunction name="getDolphins" returntype="any" output="true" access="remote" >
		...
		<cfloop query="qgetDolphins">
            ...
            <tr class="gradeU">
                ...
                <td>#DateFormat(qgetDolphins.DScoreDate, "YYYY-MM-DD")#</td>
          ...
          <!---   <cfdump var="#qgetFin_Fluke#"> --->
            ...
            <cfloop query="qgetFin_Fluke">
                ...
                <tr class="gradeU_#qgetFin_Fluke.ID#">
                    ...
                    <td>#DateFormat(qgetFin_Fluke.Date, "YYYY-MM-DD")#</td>

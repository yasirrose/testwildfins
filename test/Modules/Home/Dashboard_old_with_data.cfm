...
<cfset ZoneSurveyed = Application.SuperAdminAppNew.ZoneSurveyed()>
<!--- <cfset SegmentSurveyed = Application.SuperAdminAppNew.SegmentSurveyed()> --->
<cfset DolphinsSighted = Application.SuperAdminAppNew.DolphinsSighted()>
<cfset TotalNamedDolphins = Application.SuperAdminAppNew.TotalNamedDolphins()>
<cfset TotalCalfs = Application.SuperAdminAppNew.Totalcalfs()>
<cfset thismonthCalfs = Application.SuperAdminAppNew.thismonthcalfs()>
<cfset lastmonthcalfs = Application.SuperAdminAppNew.lastmonthcalfs()>

<cfset thismonthMMHRSP = Application.SuperAdminAppNew.thismonthMMHRSP()>
<cfset lastmonthMMHRSP = Application.SuperAdminAppNew.lastmonthMMHRSP()>

<cfset thismonthNCSG = Application.SuperAdminAppNew.thismonthNCSG()>
<cfset lastmonthNCSG = Application.SuperAdminAppNew.lastmonthNCSG()>

<cfset thismonthBiopsy = Application.SuperAdminAppNew.thismonthBiopsy()>
<cfset lastmonthBiopsy = Application.SuperAdminAppNew.lastmonthBiopsy()>

<cfset thismonthHERA = Application.SuperAdminAppNew.thismonthHERA()>
<cfset lastmonthHERA = Application.SuperAdminAppNew.lastmonthHERA()>

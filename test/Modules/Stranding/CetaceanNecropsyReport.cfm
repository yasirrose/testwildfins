    ...
    <cfoutput>
        ...
        <div class="col-lg-4" style="margin-bottom: 10px;">
            <div class="cust-row nflex">
                ...
                <input type="text" id="birthday" name="birthday" value='<cfif #qgetCetaceanNecropsy.date# neq ''>#DateTimeFormat(qgetCetaceanNecropsy.date, "YYYY-MM-DD")#<cfelseif isDefined('qgetAllData')>#DateTimeFormat(qgetAllData.date, "YYYY-MM-DD")#</cfif>' placeholder="YYYY-MM-DD"class="text-field"> 

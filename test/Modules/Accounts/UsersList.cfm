<cfif session.userdetails.userType eq "team_members" or session.userdetails.userType eq "vet_assistant ">
                        ...
                        <tbody>
                         <cfoutput query="getuserlist" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                            <tr class="gradeU">
                                ...
                                <form action="#Application.superadmin#?Module=Accounts&Page=EditUser" method="post">
                                ...
                                <cfif #session.userdetails.userType# eq "Super Admin">
                                  <div class="col-md-4" style="display:inline-block">
                                    <button class="btn btn-xs btn-danger" onClick="deleteRecord(#getuserlist.user_id#)"><i class="glyphicon glyphicon-trash"></i></button>
                                  </div>
                                 </cfif>

                                
                                <div class="col-md-4" style="display:inline-block">
                                  <form action="#Application.superadmin#?Module=Accounts&Page=ResetPassword" method="post">
                                    <input type="hidden" name="userid" value="#getuserlist.user_id#">
                                    <button type="submit" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-lock"></i></button>

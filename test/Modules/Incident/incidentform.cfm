...
<cfset qgetIR_CountyLocation = Application.SightingNew.getIR_CountyLocation()>
  ...
  <cfif isdefined('form.saveReportOnly')> 
        ...
        <cfif qInsertIncidentReport.RECORDCOUNT eq 1 >
          <cfset message ="Incident Report Added">
         <cfelse> 
        ...
        <div class="row">
             <div class="col-sm-6 box">
                <div class="row">
                    <div class="row">
                        <div class="heading">
                            <h4 class="text-uppercase"> &nbsp; Incident Report</h4>
                        </div>
                        <div class="col-sm-12">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div id="datetimepickerIR" class="input-group date col-lg-8 col-md-7 col-sm-12 col-xs-12">
                                        <input type="text" name="IR_Date" placeholder="YYYY-MM-DD" class="form-control"  >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="IR_title" id="IR_title" placeholder="Report Title" maxlength="100">
                                    <span class="">*Max 100 characters</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <input class="btn btn-success" value="Save" name="saveReportOnly" type="submit">

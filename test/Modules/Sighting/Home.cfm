                ...
                <select class="form-control search-box"  onchange="this.form.submit()" name="project_id">
                  ...
                  <cfloop query="qSurveysDate">
                    <option value="#qSurveysdate.id#"
                      <cfif isdefined('form.project_id') and form.project_id eq qSurveysdate.id>selected</cfif>> #DateTimeFormat(qSurveysdate.Date,'YYYY-MM-DD')#</option>
                  </cfloop>
                </select>
              </form>
            </div>
                ...
                <div class="box-inline">
                  <div class="form-group">
                    ...
                    <div id="datetimepicker1" class="input-group date col-lg-8 col-md-7 col-sm-12 col-xs-12">
                      <input type="text" value='#DateTimeFormat(qSurveys.Date, "YYYY-MM-DD")#' name="ProjectDate"  placeholder="YYYY-MM-DD" class="form-control"  >

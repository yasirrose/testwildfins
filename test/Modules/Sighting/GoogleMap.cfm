    ...
    <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close closeGoogleMapModal">&times;</button>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default closeGoogleMapModal">Close</button>
          </div>
      </div>
    </div>
</div>
...
function checkLatLng(){
    ...
    if(atLatitude != "" && atLongitude !=""){
      ...
      alert("Please set the At Latitude and At Longitude!");
      return false;
    }
  }
...
function validateLatLng(lat,lng){
  ...
  const myLatLng = {
      ...
      new google.maps.Marker({
        position: myLatLng,
        map,
        title: "Survey Sighting location on the google Map"
      });
      return false;
}
</script>

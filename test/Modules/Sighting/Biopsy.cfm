      ...
      <div class="main-form-section">
        <div class="row">
          ...
          <div  class="pull-right col-lg-12" style="margin-bottom:10px">
            <form role="form"  method="post" id="disp_biopsy" action="#Application.superadmin#?Module=Sighting&Page=Biopsy" > 
              <div class="col-md-4">
			...
			<table id="data-table" data-order='[[1,"asc"]]' class="table table-bordered table-hover panel">
                ...
                <cfloop query="getBiopsy">
                 ...
                 <td>
                   ...
                   <a href="#Application.superadmin#?Module=Sighting&Page=EditBiopsy&Biopsy=#Biopsy_ID#" class="btn btn-xs btn-primary update"><i class="fa fa-pencil-square-o"></i></a>

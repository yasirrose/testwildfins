...
<cfif isdefined('FORM.addFinding')>
    <cfset qinsertLiverFinding = Application.StaticDataNew.LiverFindingInsert(argumentCollection="#Form#")>
</cfif>
<cfif isdefined('FORM.editFinding')>
    <cfset qEditLiverFinding = Application.StaticDataNew.EditLiverFinding(argumentCollection="#Form#")>
</cfif>
<cfset qLiverFinding= Application.StaticDataNew.getLiverFinding()>
<!-- begin #content -->
<div id="content" class="content">
    <!-- begin breadcrumb -->
    <ol class="breadcrumb pull-right">
        <li><a href="javascript:;">Home</a></li>
        <li><a href="javascript:;">Liver Findings</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Liver Findings</h1>
    <!-- end page-header -->
    <cfif isdefined('qEditLiverFinding')>
        <div class="alert alert-success fade in m-b-10" id="sucess-div">
            ...
            <cfif isdefined('qinsertLiverFinding')>
            <div class="alert alert-success fade in m-b-10" id="sucess-div">
    ...
    <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-10">
                <h5 class="m-t-0">Create Liver Findings Record</h5>
...
<div class="form-group">
    <div class="alert alert-success message" style="display:none">
        <strong>Success!</strong> Liver Finding Deleted.
    </div>
</div>
    ...
    <div class="form-group m-b-10" style="overflow: hidden;">
        ...
        <div class="panel pagination-inverse m-b-0 clearfix">
            <table id="example"  class="table table-bordered table-hover">
                ...
                <tbody>
                    <cfoutput query="qLiverFinding">
                        <tr class="inverse" id="remov_#ID#">
                            <td>#qLiverFinding.currentRow#</td>

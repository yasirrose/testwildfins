...
<cfif isdefined('FORM.addlocation')>
    <cfset qinsertParasiteLocation = Application.StaticDataNew.ParasiteLocationInsert(argumentCollection="#Form#")>
</cfif>
<cfif isdefined('FORM.editlocation')>
    <cfset qEditParasiteLocation = Application.StaticDataNew.EditParasiteLocation(argumentCollection="#Form#")>
</cfif>
<cfset qParasiteLocation= Application.StaticDataNew.getParasiteLocation()>
<!-- begin #content -->
<div id="content" class="content">
    <!-- begin breadcrumb -->
    <ol class="breadcrumb pull-right">
        <li><a href="javascript:;">Home</a></li>
        <li><a href="javascript:;">Parasite Location</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Parasite Location</h1>
    <!-- end page-header -->
    <cfif isdefined('qEditParasiteLocation')>
        <div class="alert alert-success fade in m-b-10" id="sucess-div">
            ...
            <cfif isdefined('qinsertParasiteLocation')>
            <div class="alert alert-success fade in m-b-10" id="sucess-div">
    ...
    <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-10">
                <h5 class="m-t-0">Create Parasite Location Record</h5>
...
<div class="form-group">
    <div class="alert alert-success message" style="display:none">
        <strong>Success!</strong> Parasite Location Deleted.
    </div>
</div>
        ...
        <div class="panel pagination-inverse m-b-0 clearfix">
            <table id="example"  class="table table-bordered table-hover">
                <thead>
                    <tr class="inverse">
                        <th>Sr#</th>
                        <th>Parasite Location</th>
                        <th>Status</th>
                        <th class="text-center">Action</th>
                    </tr>
                </thead>
                <tbody>
                    <cfoutput query="qParasiteLocation">
                        <tr class="inverse" id="remov_#ID#">
                            <td>#qParasiteLocation.currentRow#</td>

...
<cfif isdefined('FORM.addType')>
    <cfset qInsertType = Application.StaticDataNew.BiopsyTypeInsert(argumentCollection="#Form#")>
...
<cfif isdefined('FORM.editType')>
    <cfset qEditType = Application.StaticDataNew.EditBiopsyType(argumentCollection="#Form#")>
    <cfif qEditType.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetType= Application.StaticDataNew.getBiopsyType()>
...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li><a href="javascript:;">Biopsy Type</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Biopsy Type</h1>
    <!-- end page-header -->
    ...
    <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-10">
                <h5 class="m-t-0">Create Biopsy Type Record</h5>
    ...
    <div class="form-group">
        <div class="alert alert-success message" style="display:none">
            <strong>Success!</strong> Biopsy Type Deleted.
        </div>
        </div>

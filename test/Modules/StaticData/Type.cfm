...
<cfif isdefined('FORM.addType')>
    <cfset qInsertType = Application.StaticData.TypeInsert(argumentCollection="#Form#")>
...
<cfif isdefined('FORM.editType')>
    <cfset qEditType = Application.StaticData.EditType(argumentCollection="#Form#")>
...
<cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
	<cfset   qgetType=Application.StaticData.getTypeByword(form.searchword)>
</cfif>
		...
		<div id="content" class="content">
            ...
            <div class="form-group">
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong> Type Deleted.
                </div>
                </div>
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create Type Record</h5>
                     ...
                     <cfoutput>
                      ...
                      <input type="text" class="form-control" name="Type" id="TypeName" placeholder="please input Type" required/>
                                </div>
                            </div>
							<div class="form-group m-b-10">
                ...
                <div class="panel pagination-inverse m-b-0 clearfix">
                    <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        <thead>
                      	 ...
                      	 <tbody>
                         <cfoutput query="qgetType" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                         	<tr class="inverse" id="remov_#ID#">
                                <td>#qgetType.currentRow#</td>
                                <td id='cam-#id#'>#Type#</td>
								 <td>
                                	<cfif active eq 1 >
	                                Active
	                                <cfelse>

...
<cfif isdefined('FORM.addHitLocation')>
    <cfset qHitLocationInsert = Application.StaticData.HitLocationInsert(argumentCollection="#Form#")>
    <cfif qHitLocationInsert.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>

<cfif isdefined('FORM.editHitLocation')>
    <cfset qEditHitLocation = Application.StaticData.EditHitLocation(argumentCollection="#Form#")>
    <cfif qEditHitLocation.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetHitLocation = Application.StaticData.getHitLocation()>
 
  <cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetHitLocation=Application.StaticData.getHitLocationByword(form.searchword)>
</cfif>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Hit Location</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Hit Location</h1>
			<!-- end page-header -->
			
                <cfif isdefined('qEditHitLocation') and qEditHitLocation.recordcount eq 1 >
				   ...
				   <cfif isdefined('qHitLocationInsert') and qHitLocationInsert.recordcount eq 1 >
                    <div class="alert alert-success fade in m-b-10" id="sucess-div">
                ...
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong>  Hit Location Deleted.
                </div>
                </div>
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create  Hit Location</h5>
                     <cfoutput>
                        <form class="form-horizontal" action="" name="add-zone" method="post">
                            <div class="form-group m-b-10">
                                <label class="col-md-3 control-label">Hit Location Abbreviation</label>
                                <div class="col-md-7">
                      <input type="text" class="form-control" name="HitLocationAbbreviation" id="HitLocationAbbreviation" required/>
                                </div>
                            </div>
                            <div class="form-group m-b-10">
               ...
               <input type="text" class="form-control" name="Description" id="Description"  required/>
                         ...
                         <input type="hidden" value="" id="HitLocation_id" name="ID">
               ...
               <div class="form-group m-b-10" style="overflow: hidden;">
                ...
                <div class="panel pagination-inverse m-b-0 clearfix">
                    <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                       ...
                       <cfoutput query="qgetHitLocation" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                         	<tr class="inverse" id="remov_#ID#">
                                <td>#qgetHitLocation.currentRow#</td>
                                <td id='HitLocationAbbreviation-#ID#'>#HitLocationAbbreviation#</td>
     ...
     <cfset qpagination = qgetHitLocation >

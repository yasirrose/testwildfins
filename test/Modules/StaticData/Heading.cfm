...
<cfif isdefined('FORM.addAssocBio')>
    <cfset qInsertHeading = Application.StaticDataNew.HeadingInsert(argumentCollection="#Form#")>
    <cfif qInsertHeading.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>

<cfif isdefined('FORM.editHeading')>
    <cfset qEditHeading = Application.StaticDataNew.EditHeading(argumentCollection="#Form#")>
    <cfif qEditHeading.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetHeading = Application.StaticDataNew.getHeading ()>
 
 <cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetHeading=Application.StaticDataNew.getAssocBioByword(form.searchword)>
</cfif>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Initial Heading</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Initial Heading</h1>
			<!-- end page-header -->
			<cfif isdefined('qEditHeading') and qEditHeading.recordcount eq 1 >
				   ...
				   <cfif isdefined('qInsertHeading') and qInsertHeading.recordcount eq 1 >
                    <div class="alert alert-success fade in m-b-10" id="sucess-div">
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create Initial Heading Record</h5>
                  
                     <cfoutput>
                        <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-camara" method="post">
                            <div class="form-group m-b-10">
                                <label class="col-md-3 control-label">Initial Heading</label>
                                <div class="col-md-7">
                                	 <input type="hidden" name="ID" value='' id="Heading_id" />
                                     <input type="text" class="form-control" name="Heading" id="HeadingName" placeholder="Please Input Initial Heading" required/>
                                </div>
                            </div>
							<div class="form-group m-b-10">
            ...
            <div class="form-group">
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong> Initial Heading Deleted.
                </div>
                </div>
                ...
                <div class="panel pagination-inverse m-b-0 clearfix">
                    <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        <thead>
                      	 ...
                      	 <tbody>
                         <cfoutput query="qgetHeading" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                         	<tr class="inverse" id="remov_#ID#">
                                <td>#qgetHeading.currentRow#</td>
                                <td id='cam-#ID#'>#HeadingName#</td>
								 <td>
                                	<cfif active eq 1 >
	                                   Active
	                                <cfelse>

...
<cfif isdefined('FORM.addType')>
    <cfset qInsertType = Application.StaticDataNew.SampleLocationInsert(argumentCollection="#Form#")>
...
<cfif isdefined('FORM.editType')>
    <cfset qEditType = Application.StaticDataNew.EditSampleLocation(argumentCollection="#Form#")>
    <cfif qEditType.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetType= Application.StaticDataNew.getSampleLocation()>

<cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetType=Application.StaticDataNew.getSampleLocationByword(form.searchword)>
</cfif>
		<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Sample Location</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Sample Location</h1>
			<!-- end page-header -->
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create Sample Location Record</h5>
                  
                     <cfoutput>
                        <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-type" method="post">
                            <div class="form-group m-b-10">
                                <label class="col-md-3 control-label">Sample Location</label>
                                <div class="col-md-7">
            ...
            <div class="form-group">
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong> Sample Location Deleted.
                </div>
                </div>

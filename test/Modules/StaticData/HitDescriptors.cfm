...
<cfif isdefined('FORM.addHitLocation')>
    <cfset qHitDescriptorsInsert = Application.StaticData.HitDescriptorsInsert(argumentCollection="#Form#")>
    <cfif qHitDescriptorsInsert.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>

<cfif isdefined('FORM.editHitDescriptors')>
    <cfset qEditHitDescriptors = Application.StaticData.EditHitDescriptors(argumentCollection="#Form#")>
    <cfif qEditHitDescriptors.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetHitDescriptors = Application.StaticData.getHitDescriptors()>
 
  <cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetHitDescriptors=Application.StaticData.getHitDescriptorsByword(form.searchword)>
</cfif>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Hit Descriptors</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Hit Descriptors</h1>
			<!-- end page-header -->
			
                <cfif isdefined('qEditHitDescriptors') and qEditHitDescriptors.recordcount eq 1 >
				   ...
				   <cfif isdefined('qHitDescriptorsInsert') and qHitDescriptorsInsert.recordcount eq 1 >
                    <div class="alert alert-success fade in m-b-10" id="sucess-div">
                ...
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong>  Hit Descriptors Deleted.
                </div>
                </div>
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create  Hit Descriptors</h5>
                     <cfoutput>
                        <form class="form-horizontal" action="" name="add-zone" method="post">
                            <div class="form-group m-b-10">
                                <label class="col-md-3 control-label">Hit Descriptors :</label>
                                <div class="col-md-7">
                      				<input type="text" class="form-control" name="HitDescriptors" id="HitDescriptors" required/>
                                </div>
                            </div>
                         ...
                         <input type="hidden" value="" id="HitDescriptors_id" name="ID">
               ...
               <div class="form-group m-b-10" style="overflow: hidden;">
                ...
                <div class="panel pagination-inverse m-b-0 clearfix">
                    <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                       ...
                       <cfoutput query="qgetHitDescriptors" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                         	<tr class="inverse" id="remov_#ID#">
                                <td>#qgetHitDescriptors.currentRow#</td>
                                <td id='HitDescriptors-#ID#'>#HitDescriptors#</td>
                            	<td>
                                	<cfif active eq 1 >
	                                	Active
	                                <cfelse>
     ...
     <cfset qpagination = qgetHitDescriptors >

...
<cfif isdefined('FORM.addType')>
    <cfset qInsertType = Application.StaticDataNew.DiagnosticTestInsert(argumentCollection="#Form#")>
...
<cfif isdefined('FORM.editType')>
    <cfset qEditType = Application.StaticDataNew.EditDiagnosticTest(argumentCollection="#Form#")>
    <cfif qEditType.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetType= Application.StaticDataNew.getDiagnosticTest()>

<cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetType=Application.StaticDataNew.getDiagnosticTestByword(form.searchword)>
</cfif>
		<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Diagnostic Test</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Diagnostic Test</h1>
			<!-- end page-header -->
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create Diagnostic Test Record</h5>
            ...
            <div class="form-group">
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong> Diagnostic Test Deleted.
                </div>
                </div>

...
<cfif isdefined('FORM.addCetaceanSpecies')>
<cfset qInsertCetaceanSpecies = Application.StaticDataNew.CetaceanSpeciesInsert(argumentCollection="#Form#")>
<cfif qInsertCetaceanSpecies.recordcount eq 1>
   <cfelse>
</cfif>
</cfif>
<cfif isdefined('FORM.editCetaceanSpecies')>
<cfset qEditCetaceanSpecies = Application.StaticDataNew.EditCetaceanSpecies(argumentCollection="#Form#")>
<cfif qEditCetaceanSpecies.recordcount eq 1>
   <cfelse>
</cfif>
</cfif>
...
<cfset   qgetCetaceanSpecies=Application.StaticDataNew.getCetaceanSpeciesByword(form.searchword)>
</cfif>
<!-- begin #content -->
<div id="content" class="content">
   ...
   <ol class="breadcrumb pull-right">
      ...
      <li><a href="javascript:;">Cetacean Species</a></li>
   </ol>
   <!-- end breadcrumb -->
   <!-- begin page-header -->
   <h1 class="page-header">Cetacean Species</h1>
   <!-- end page-header -->
   <cfif isdefined('qEditCetaceanSpecies') and qEditCetaceanSpecies.recordcount eq 1 >
   ...
   <cfif isdefined('qInsertCetaceanSpecies') and qInsertCetaceanSpecies.recordcount eq 1 >
   <div class="alert alert-success fade in m-b-10" id="sucess-div">
   ...
   <div class="section-container section-with-top-border p-b-10">
      <div class="row">
         <!-- begin col-6 -->
         <div class="col-md-10">
            <h5 class="m-t-0">Create Cetacean Species Record</h5>
            <cfoutput>
               <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-camara" method="post">
                  <div class="form-group m-b-10">
                     ...
                     <div class="col-md-7">
                        <input type="hidden" name="ID" value='' id="CetaceanSpecies_id" />
                        <input type="text" class="form-control" name="CetaceanSpeciesName" id="CetaceanSpeciesName" placeholder="Please input Cetacean Species" required/>
                     </div>
                  </div>
                  <div class="form-group m-b-10">
                  ...
                  <div class="col-md-7 col-md-offset-3">
                     <button type="submit" name="addCetaceanSpecies" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
   ...
   <div class="form-group">
      <div class="alert alert-success message" style="display:none">
         <strong>Success!</strong> Cetacean Species Deleted.
      </div>
   </div>
   ...
   <div class="section-container section-with-top-border">
      ...
      <div class="panel pagination-inverse m-b-0 clearfix">
         <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
            ...
            <tbody>
               <cfoutput query="qgetCetaceanSpecies" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                  <tr class="inverse" id="remov_#ID#">
                     <td>#qgetCetaceanSpecies.currentRow#</td>
                     <td id='cam-#id#'>#CetaceanSpeciesName#</td>
                     <td>
                        <cfif active eq 1 >
                           Active
                           <cfelse>
         ...
         <cfset qpagination = qgetCetaceanSpecies >

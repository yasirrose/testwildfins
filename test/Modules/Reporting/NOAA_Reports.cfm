              ...
              <div class="col-md-12">
                ...
                <div class="col-md-3">
                  ...
                  <div id="datetimepicker1" class="input-group date col-lg-9 col-md-7 col-sm-12 col-xs-12">
                    <input type="text"  value='#application.Common.FormatDate(Date_from)#' name="Date_from"  placeholder="YYYY-MM-DD" class="form-control">
                ...
                <div class="col-md-3">
                  ...
                  <div id="datetimepicker2" class="input-group date col-lg-9 col-md-7 col-sm-12 col-xs-12">
                    <input type="text"  value='#application.Common.FormatDate(Date_to)#' name="Date_to"  placeholder="YYYY-MM-DD" class="form-control">
                    <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span> </div>
                </div>
                </div>
                <div class="col-md-3">

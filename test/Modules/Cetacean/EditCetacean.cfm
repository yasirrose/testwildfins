                    ...
                    <div class="col-md-4" style="border-right: solid 0.5px ##EEEEEE">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                 ...
                                 <input type="text" class="form-control datetimepicker" id="datetimepickerEST" name="Date_of_Birth_EST" value="#dateFormat(getCetacean.DateOfBirthEstimate,"YYYY-MM-DD")#" placeholder="YYYY-MM-DD">
                              </div>
                           ...
                           <div class="col-md-4" style="border-right: solid 0.5px ##EEEEEE">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                 ...
                                 <input type="text" class="form-control datetimepicker" name="Date_of_Death" value="#dateFormat(getCetacean.DateDeath,"YYYY-MM-DD")#" placeholder="YYYY-MM-DD">
                              </div>
                              <div class="form-group">
                                 <label for="email">First Sighting Date:</label>
                                 <input type="text" class="form-control datetimepicker" name="First_Sighting_Date" value="#dateFormat(getCetacean.FirstSightingDate,"YYYY-MM-DD")#" placeholder="YYYY-MM-DD">
                              </div>

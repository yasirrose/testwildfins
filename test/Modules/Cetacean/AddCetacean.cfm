...
<!--- <cfset setDate = DateFormat(Now(),'YYYY-MM-DD')> --->
                    ...
                    <div class="col-md-4" style="border-right: solid 0.5px ##EEEEEE">
                           ...
                           <div class="col-md-4" style="border-right: solid 0.5px ##EEEEEE">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control datetimepicker" name="Date_of_Birth_EST" placeholder="YYYY-MM-DD">
                              </div>
                               ...
                               <div class="form-group">
                                 ...
                                 <input type="text" class="form-control datetimepicker" name="Date_of_Death" placeholder="YYYY-MM-DD">
                              </div>
                              <div class="form-group">
                                 <label for="email">First Sighting Date:</label>
                                 <input type="text" class="form-control datetimepicker" name="First_Sighting_Date" placeholder="YYYY-MM-DD">
                              </div>

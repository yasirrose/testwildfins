            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (i = 0; i <=obj.DATA.length; ++i) {
                        $('#lesion_table').append('<tr><td class="tddate">' +moment(obj.DATA[i][2]).format("YYYY-MM-DD")+'</td><td class="sno">' +obj.DATA[i][0]+'</td><td class="ltype">' +obj.DATA[i][3]+'</td><td class="lside">' +obj.DATA[i][5]+'</td><td class="lstatus">' +obj.DATA[i][6]+'</td><td class="lregion">' +obj.DATA[i][4]+'</td></tr>');
                    }
                },
                error: function (err) {
                    console.log("error:", err);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(obj.DATA.length){
                        ...
                        $('#updtaedata').append('<select id="unqueLesions"></select><select id="sel"><option value="YES">YES</option><option value="NO">NO</option><option value="CBD">CBD</option></select>');
        ...
        if (isSetaceanSelected != "") {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $('#add_cetaceansSighting_btn').css("display", "block");
                    $("#alt_images").html("");
...
function getSingleCS_Record(cs_ID) {
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#update_cetaceansSighting_btn').css("display", "block");

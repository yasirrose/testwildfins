        ...
        <div id="content" class="content">
			...
			<div class="col-md-4" style="border-right: solid 0.5px ##EEEEEE">
               ...
               <label for="sel1">Select Dolphin</label>
                ...
                <input type="text" class="form-control datepicker-sdo" name="PRES_LOBO_DATE" value="#DATEFORMAT(qgeSDO.PRES_LOBO_DATE,'YYYY-MM-DD')#" placeholder="YYYY-MM-DD" required >
                </div>
                ...
                <input type="text" class="form-control " name="Lobo_Confirmed" value="#qgeSDO.Lobo_Confirmed#" required >
                 ...
                 <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker-sdo" value="#DATEFORMAT(qgeSDO.Recapture_Date_1,'YYYY-MM-DD')#"  name="Recapture_Date_1" placeholder="YYYY-MM-DD" required >
                 </div>
                 
				<div class="form-group">
					<label for="email">Recapture Date 2:</label>
					<input type="text" class="form-control datepicker-sdo" name="Recapture_Date_2" value="#DATEFORMAT(qgeSDO.Recapture_Date_2,'YYYY-MM-DD')#" placeholder="YYYY-MM-DD" required >
                </div>
                
                <div class="form-group">
                        <label for="email">Recapture Date 3:</label>
                        <input type="text" class="form-control datepicker-sdo" name="Recapture_Date_3" value="#DATEFORMAT(qgeSDO.Recapture_Date_3,'YYYY-MM-DD')#" placeholder="YYYY-MM-DD" required ></div>
            ...
            <div class="col-md-4" style="border-right: solid 0.5px ##EEEEEE">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control datepicker-sdo" value="#DATEFORMAT(qgeSDO.FinChange1,'YYYY-MM-DD')#" name="FinChange1" required >
                    </div>
                    
                    <div class="form-group">
                    <label for="email">Fin Change 2:</label>
                    <input type="text" class="form-control datepicker-sdo" value="#DATEFORMAT(qgeSDO.FinChange2,'YYYY-MM-DD')#" name="FinChange2" required >
                    </div>
                    <div class="form-group">
                    <label for="email">Fin Change 3:</label>
                    <input type="text" class="form-control datepicker-sdo" value="#DATEFORMAT(qgeSDO.FinChange3,'YYYY-MM-DD')#" name="FinChange3" required >
                    </div>
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control datepicker-sdo" value="#DATEFORMAT(qgeSDO.FB_on_Date,'YYYY-MM-DD')#" name="FB_on_Date" placeholder="YYYY-MM-DD" required >
                   </div>

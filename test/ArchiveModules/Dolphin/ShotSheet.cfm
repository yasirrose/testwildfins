<div id="content" class="content">
  <h2 style="text-align: center">Biopsy Shot Sheet</h2>
  <cfoutput>
                  ...
                  <cfif isdefined('form.PROJECT_ID') and form.PROJECT_ID neq 0>
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                              ...
                              <input type="text"  id="shcount" name="shotcou" class="form-control" value="">
                          </div>
                      </div>
            ...
            <div class="col-md-12">
              ...
              <div class="row">
                ...
                <cfloop query="getprojectTeamnames">
                    ...
                    <!---<div class="form-group">--->
                        <!---<label for="">Probable Dolphin</label>--->
                        <!---<input type="text" name="probable_dolphin" class="form-control">--->
                    <!---</div>--->

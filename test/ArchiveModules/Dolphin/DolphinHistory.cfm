 ...
 obj = JSON.parse(arr);
  ...
  <div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
      <li><a href="javascript:;">#URL.ArchiveModule#</a></li>
    ...
    <div class="section-container section-with-top-border p-b-10">
      ...
      <div class="row">
          ...
          <div  class="pull-right col-lg-12" style="margin-bottom:10px">
			...
			<div class='row'>
                <div class="col-md-5">
                    <form id="myform" class="dolphin-form" action="#Application.siteroot#?ArchiveModule=Dolphin&Page=DolphinHistory&Archive" method="post" >
                ...
                <div class="col-md-2 col-md-offset-1 m-t-25">
                    <form id="detailform" action="#Application.siteroot#?ArchiveModule=Dolphin&Page=EditDolphin&Archive" method="post" >
               ...
               <div class="col-lg-4">
                 ...
                 <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="DolphinID_fetch" id="DOD"  readonly="readonly"  value="#DateFormat(qgetdolphin.DOD,'YYYY-MM-DD')#">
                  </div>
                </div>
                 <div class="col-lg-2">
                  <div class="form-group">
               ...
               <div class="col-lg-4">
                 ...
                 <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"   readonly="readonly"  value="#DateFormat(qgetdolphin.DistinctDate,'YYYY-MM-DD')#">
                  </div>
                </div>
                 <div class="col-lg-4">
                  <div class="form-group">
                    <label for="email">First Sighting Date :</label>
                    <input type="text" class="form-control" id="total_sightings"  readonly="readonly" value="#DateFormat(qgetdolphin.First_Sighting_Date,'YYYY-MM-DD')#">
                  </div>
                </div>
                </div>
						...
						<cfif isdefined('FORM.DOLPHINID')>	
							<cfloop query='qgetdolphin'>
								<tr role="row" class="odd">
									<td class="sorting_1">#DateFormat(DATESEEN,'YYYY-MM-DD')#</td>
                                         ...
                                         <td style='width:25%'>#qgetdolphinFriends.Sex#</td>
                                          <td style='width:25%'>#qgetdolphinFriends.times#</td>
                                           <td style='width:25%' align="center">
                                            <form  action="#Application.siteroot#?ArchiveModule=Dolphin&Page=DolphinHistory&Archive" method="post" >
                            ...
                            <table class="table table-striped table-bordered dataTable no-footer ">
                              ...
                              <cfif isdefined('FORM.DOLPHINID') and isdefined("qgetSightingHistory")>	
                                <cfloop query='qgetSightingHistory'>
                                     <tr >
                                         <td style='width:28%'>#DateFormat(Dolphin_Sighting_Date,'YYYY-MM-DD')#</td>
...
<style>
  .dolphin-form .select2-container--default {
    width: 100% !important;
  }

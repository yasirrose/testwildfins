...
<cfif isdefined('FORM.addWaveHeight')>
    <cfset qInsertWaveHeight = Application.StaticData.WaveHeightInsert(argumentCollection="#Form#")>
    <cfif qInsertWaveHeight.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>

<cfif isdefined('FORM.editWaveHeight')>
    <cfset qEditWaveHeight = Application.StaticData.EditWaveHeight(argumentCollection="#Form#")>
    <cfif qEditWaveHeight.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetWaveHeight = Application.StaticData.getWaveHeight()>
 
 
 <cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetWaveHeight=Application.StaticData.getWaveHeightByword(form.searchword)>
</cfif>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">WaveHeight</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">WaveHeight</h1>
			<!-- end page-header -->
			<cfif isdefined('qEditWaveHeight') and qEditWaveHeight.recordcount eq 1 >
				   ...
				   <cfif isdefined('qInsertWaveHeight') and qInsertWaveHeight.recordcount eq 1 >
                    <div class="alert alert-success fade in m-b-10" id="sucess-div">
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create WaveHeight Record</h5>
                     <cfoutput>
                        <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-camara" method="post">
                            <div class="form-group m-b-10">
                                <label class="col-md-3 control-label">WaveHeight</label>
                                <div class="col-md-7">
                                	 <input type="hidden" name="ID" value='' id="WaveHeight_id" />
                      <input type="text" class="form-control" name="WaveHeight" id="WaveHeightName" placeholder="please input WaveHeight" required/>
                                </div>
                            </div>
							<div class="form-group m-b-10">
       ...
       <button type="submit" name="addWaveHeight" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
            ...
            <div class="form-group">
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong> Wave Height Deleted.
                </div>
                </div>
                ...
                <div class="panel pagination-inverse m-b-0 clearfix">
                    <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        <thead>
                      	 ...
                      	 <tbody>
                         <cfoutput query="qgetWaveHeight" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                         	<tr class="inverse" id="remov_#ID#">
                                <td>#qgetWaveHeight.currentRow#</td>
     ...
     <cfset qpagination = qgetWaveHeight >

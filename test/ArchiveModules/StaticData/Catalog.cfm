...
<cfparam name="form.searchword" default="">
  <cfif isdefined('FORM.addCatalog')>
    <cfset qInsertCatalog = Application.StaticData.CatalogInsert(argumentCollection="#Form#")>
    <cfif qInsertCatalog.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>

<cfif isdefined('FORM.editCatalog')>
    <cfset qEditCatalog = Application.StaticData.EditCatalog(argumentCollection="#Form#")>
    <cfif qEditCatalog.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetCatalog = Application.StaticData.getCatalog()>
 
  <cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetCatalog=Application.StaticData.getCatalogByword(form.searchword)>
</cfif>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Camera Catalog</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Catalog</h1>
			<!-- end page-header -->
                <cfif isdefined('qEditCatalog') and qEditCatalog.recordcount eq 1 >
			  ...
			  <cfif isdefined('qInsertCatalog') and qInsertCatalog.recordcount eq 1 >
                    <div class="alert alert-success fade in m-b-10" id="sucess-div">
                ...
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong> Catalog Deleted.
                </div>
                </div>
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create Catalog Entry</h5>
                     <cfoutput>
                        <form class="form-horizontal" action="#Application.siteroot#?ArchiveModule=StaticData&Page=Catalog&Archive" name="add-Catalog" method="post">
                            <div class="form-group m-b-10">
                                <label class="col-md-3 control-label">Catalog Name</label>
                                <div class="col-md-7">
                      <input type="text" class="form-control" name="Catalog" id="Catalog" placeholder="please input Catalog name" required/>
                                </div>
                            </div>
							<div class="form-group m-b-10">
       ...
       <button type="submit" name="addCatalog" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
              ...
              <div class="form-group m-b-10" style="overflow: hidden;">
                ...
                <div class="panel pagination-inverse m-b-0 clearfix">
                    <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                       ...
                       <tbody>
                       		<cfoutput query="qgetCatalog" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                         	<tr class="inverse" id="remov_#ID#">
                                <td>#qgetCatalog.currentRow#</td>
                                <td id='Catalog-#ID#'>#Catalog#</td>
								 <td>
                                	<cfif active eq 1 >
	                                Active
	                                <cfelse>

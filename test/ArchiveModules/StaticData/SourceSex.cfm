...
<div id="content" class="content">
    <ol class="breadcrumb pull-right">
        ...
        <li><a href="javascript:;">Source Sex</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
...
<div class="row">
    <!-- begin col-6 -->
<div class="col-md-10">
    <h5 class="m-t-0">Create Source Sex Record</h5>
<cfoutput>
        <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-camara" method="post">
        <div class="form-group m-b-10">
            <label class="col-md-3 control-label">Source Sex</label>
            <div class="col-md-7">
                <input type="hidden" name="ID" value='' id="sex_id" />
                <input type="text" class="form-control" name="sourcesex" id="source_sex" placeholder="please input Source Sex" required/>
            </div>
        </div>
        <div class="form-group m-b-10">
        ...
        <div class="col-md-7 col-md-offset-3">
            <button type="submit" name="addSourceSex" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
...
<tbody>
<cfoutput query="getsourceSex" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
    <tr class="inverse" id="remov_#ID#">
<td>#getsourceSex.currentRow#</td>
        <td id='cam-#ID#'>#Ssex#</td>
<td>
    <cfif active eq 1 >
            Active
    <cfelse>
...
<cfset qpagination = getsourceSex>

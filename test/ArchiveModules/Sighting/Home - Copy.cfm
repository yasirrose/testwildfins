...
<!------ Takes ----->
    ...
    <input type="checkbox" name="dgree" value="C" class="myCheckbox"> : C <br>
    <input type="checkbox" name="dgree" value="F" class="myCheckbox"> : F
    ...
    <div class="inner-border-box">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                <label class="col-lg-5 col-md-5 col-sm-6 control-label">Feeding Latitude
            ...
            <div class="form-group">
                <label class="col-lg-5 col-md-5 col-sm-6 control-label">Feeding Longitude
                </label>
            <div class="input col-lg-5 col-md-9 col-sm-6 col-xs-6">

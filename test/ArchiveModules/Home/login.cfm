<cfif isdefined('form.loginForm')>
    ...
    <cfif qGetSuperAdmin.RecordCount eq 1>
        ...
        <cflocation addtoken="no" url="#Application.siteroot#?ArchiveModule=Home&Page=Dashboard&Archive" >
    <cfelse>
...
<div class="login">
            ...
            <div class="login-content">
                <form action="#Application.siteroot#?ArchiveModule=Home&Page=login&Archive" method="POST" name="login_form" id="login_form" class="form-input-flat">

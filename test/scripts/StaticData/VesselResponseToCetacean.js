function deleteRecord(id) {
    bootbox.confirm("Are you sure?", function(result) {
        ...
        if (result == true) {
            $.ajax({
                url: application_root + "StaticDataNew.cfc?method=DeleteVesselResponseToCetacean",
                type: "get",
                data: {
                    id: id
                },
...
function updateRecord(id) {
    ...
    $("#add").attr('name', 'editVesselResponseToCetacean');
    $("#add").text('Edit');
    $("#VesselResponseToCetacean_id").val(id);

function deleteRecord(id) {
	...
	if (result == true) {
		$.ajax({
			url:application_root+"StaticData.cfc?method=DeleteHitDescriptors",
			type : "get",
			data : {id : id},
			async:true,
...
function updateRecord(id) {
	$('#HitDescriptors').val($('#HitDescriptors-'+id).text());
	$("#add").attr('name', 'editHitDescriptors');
	$("#add").text('Edit');
	$("#HitDescriptors_id").val(id);

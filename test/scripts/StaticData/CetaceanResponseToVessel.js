function deleteRecord(id) {
    bootbox.confirm("Are you sure?", function(result) {
        ...
        if (result == true) {
            $.ajax({
                url: application_root + "StaticDataNew.cfc?method=DeleteCetaceanResponseToVessel",
                type: "get",
                data: {
                    id: id
                },
...
function updateRecord(id) {
    ...
    $("#add").attr('name', 'editCetaceanResponseToVessel');
    $("#add").text('Edit');
    $("#CetaceanResponseToVessel_id").val(id);

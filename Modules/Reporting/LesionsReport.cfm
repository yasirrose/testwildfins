...
<cfif permissions eq "full_access" or findNoCase("Run Report S-S-C", permissions) neq 0>
    ...
    <cfif isdefined('FORM.btnSearchSightings') or isdefined('FORM.pge')>
            ...
            <cfif #sightingID# neq "" and #Cetaceans_I# neq ""> 
                ...
                <cfif cldd.RECORDCOUNT gte 1 >
                    ...
                    <cfloop query="cldd" > 
                        ...
                        <cfset st =  "Status" & #cc#>
                        <cfset pn =  "PhotoNumber" & #cc#>
                        <cfset cn =  "Comments" & #cc#>
                        ...
                        <cfset QuerySetCell(allCount, "#pn#", #PhotoNumber#, allCount.currentRow)>
                        <cfset QuerySetCell(allCount, "#cn#", #Comments#, allCount.currentRow)>
                        <cfif #Region# NEQ "">
        ...
        <cfloop index="index" from="1" to="#maximumLesions.MaxLesion#">
                ...
                <cfset st =  "Status" & #rr#>
                <cfset re =  "Region" & #rr#>
                <cfset pn =  "PhotoNumber" & #rr#>
                <cfset cn =  "Comments" & #rr#>

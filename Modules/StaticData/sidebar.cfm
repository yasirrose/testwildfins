...
<ul class="sub-menu">
        ...
        <li class="has-sub <cfif Page eq 'WaveHeight' OR Page eq 'Weather' OR Page eq 'Sightability' or Page eq 'Beaufort' or Page eq 'Glare' or Page eq 'GlareDirection' or Page eq 'Heading' or Page eq 'AssocBio'>active</cfif>" >
    <a href="javascript:;">
        <b class="caret pull-right"></b>
    ...
    <ul class="sub-menu">
            ...
            <li <cfif Page eq 'GlareDirection' > class='active'</cfif>><a href="#Application.superadmin#?Module=StaticData&Page=GlareDirection">Glare Direction</a></li>
            <li <cfif Page eq 'Heading' AND NOT isArchive> class='active'</cfif>><a href="#Application.superadmin#?Module=StaticData&Page=Heading">Heading</a></li> 

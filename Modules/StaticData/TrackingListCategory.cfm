...
<cfif isdefined('FORM.addCategory')>
    <cfset qInsertCategory = Application.StaticDataNew.CategoryInsert(argumentCollection="#Form#")>
    <cfif qInsertCategory.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>

<cfif isdefined('FORM.editCategory')>
    <cfset qEditCategory = Application.StaticDataNew.EditCategory(argumentCollection="#Form#")>
    <cfif qEditCategory.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
...
<cfset   qgetCategory=Application.StaticDataNew.getCategoryByword(form.searchword)>
</cfif>
		<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Tracking List Category</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Category</h1>
			<!-- end page-header -->
			<cfif isdefined('qEditBehavior') and qEditCategory.recordcount eq 1 >
				   ...
				   <cfif isdefined('qInsertBehavior') and qInsertCategory.recordcount eq 1 >
                    <div class="alert alert-success fade in m-b-10" id="sucess-div">
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create Category Record</h5>
                  
                     <cfoutput>
                        <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-category" method="post">
                            <div class="form-group m-b-10">
                                <label class="col-md-3 control-label">Category Name</label>
                                <div class="col-md-7">
                                    <input type="hidden" name="ID" value='' id="Category_id" />
                                    <input type="text" class="form-control" name="CategoryName" id="CategoryName" placeholder="Please Input Category Name" required/>
                                </div>
                            </div>
							<div class="form-group m-b-10">
							...
							<div class="col-md-7 col-md-offset-3">
                                <button type="submit" name="addCategory" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
                ...
                <div class="panel pagination-inverse m-b-0 clearfix">
                    <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        <thead>
                      	 ...
                      	 <tbody>
                         <cfoutput query="qgetCategory" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                         	<tr class="inverse" id="remov_#ID#">
                                <td>#qgetCategory.currentRow#</td>
                                <td id='catname-#id#'>#CategoryName#</td>
								<td>
									<cfif status eq 1 >
                                    Active
                                    <cfelse>
     ...
     <cfset qpagination = qgetCategory >

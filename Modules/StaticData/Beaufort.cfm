...
<cfif isdefined('FORM.addBeaufort')>
    <cfset qInsertBeaufort = Application.StaticData.BeaufortInsert(argumentCollection="#Form#")>
    <cfif qInsertBeaufort.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>

<cfif isdefined('FORM.editBeaufort')>
    <cfset qEditBeaufort = Application.StaticData.EditBeaufort(argumentCollection="#Form#")>
    <cfif qEditBeaufort.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetBeaufort = Application.StaticData.getBeaufort()>
 
<cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetBeaufort=Application.StaticData.getBeaufortByword(form.searchword)>
</cfif>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Beaufort</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Beaufort</h1>
			<!-- end page-header -->
			<cfif isdefined('qEditBeaufort') and qEditBeaufort.recordcount eq 1 >
				   ...
				   <cfif isdefined('qInsertBeaufort') and qInsertBeaufort.recordcount eq 1 >
                    <div class="alert alert-success fade in m-b-10" id="sucess-div">
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create Beaufort Record</h5>
                  
                     <cfoutput>
                        <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-camara" method="post">
                            <div class="form-group m-b-10">
                                <label class="col-md-3 control-label">Beaufort</label>
                                <div class="col-md-7">
                                	 <input type="hidden" name="ID" value='' id="Beaufort_id" />
                      <input type="text" class="form-control" name="Beaufort" id="BeaufortName" placeholder="please input Beaufort" required/>
                                </div>
                            </div>
							<div class="form-group m-b-10">
       ...
       <button type="submit" name="addBeaufort" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
            ...
            <div class="form-group">
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong> Beaufort Deleted.
                </div>
                </div>
                ...
                <div class="panel pagination-inverse m-b-0 clearfix">
                    <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        <thead>
                      	 ...
                      	 <tbody>
                         <cfoutput query="qgetBeaufort" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                         	<tr class="inverse" id="remov_#ID#">
                                <td>#qgetBeaufort.currentRow#</td>
     ...
     <cfset qpagination = qgetBeaufort >

...
<cfelse>
    ...
    <cfloop query="exceldata" startrow="2">
        <cfquery datasource="#application.dsn#" name="insertdata" result="insert">
                  ...
                  insert into TLU_Zones([ZONE],GRIDNUM,LAT_DD,LONG_DD,EASTING,NORTHING,ZSEGMENT,ID)
                  values(
...
<cfif counter eq 1>
    <cfoutput><h3 style="text-align: center"> data inserted Successfully into TLUZones Table !</h3></cfoutput>

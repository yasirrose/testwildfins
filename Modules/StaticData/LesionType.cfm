...
<cfif isdefined('FORM.addLesionType')>
<cfset qInsertLesionType = Application.StaticDataNew.LesionTypeInsert(argumentCollection="#Form#")>
<cfif qInsertLesionType.recordcount eq 1>
   <cfelse>
</cfif>
</cfif>
<cfif isdefined('FORM.editLesionType')>
<cfset qEditLesionType = Application.StaticDataNew.EditLesionType(argumentCollection="#Form#")>
<cfif qEditLesionType.recordcount eq 1>
   <cfelse>
</cfif>
</cfif>
...
<div id="content" class="content">
   ...
   <ol class="breadcrumb pull-right">
      ...
      <li><a href="javascript:;">Lesion Type</a></li>
   </ol>
   <!-- end breadcrumb -->
   <!-- begin page-header -->
   <h1 class="page-header">Lesion Type</h1>
   <!-- end page-header -->
   <cfif isdefined('qEditLesionType') and qEditLesionType.recordcount eq 1 >
            ...
            <cfoutput>
               <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-camara" method="post">
                  ...
                  <div class="col-md-7 col-md-offset-3">
                     <button type="submit" name="addLesionType" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
   ...
   <div class="form-group">
      <div class="alert alert-success message" style="display:none">
         <strong>Success!</strong> Lesion Type Deleted.
      </div>
   </div>

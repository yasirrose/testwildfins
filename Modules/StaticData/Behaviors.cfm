...
<cfif isdefined('FORM.addBehavior')>
    <cfset qInsertBehavior = Application.StaticDataNew.BehaviorInsert(argumentCollection="#Form#")>
    <cfif qInsertBehavior.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>

<cfif isdefined('FORM.editBehavior')>
    <cfset qEditBehavior = Application.StaticDataNew.EditBehavior(argumentCollection="#Form#")>
    <cfif qEditBehavior.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetBehavior = Application.StaticDataNew.getBehavior()>

 
<cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetBehavior=Application.StaticDataNew.getBehaviorByword(form.searchword)>
</cfif>
		<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Behavior</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Behavior</h1>
			<!-- end page-header -->
			<cfif isdefined('qEditBehavior') and qEditBehavior.recordcount eq 1 >
				   ...
				   <cfif isdefined('qInsertBehavior') and qInsertBehavior.recordcount eq 1 >
                    <div class="alert alert-success fade in m-b-10" id="sucess-div">
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create Event Behavior Record</h5>
                  
                     <cfoutput>
                        <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-camara" method="post">
                            <div class="form-group m-b-10">
                                <label class="col-md-3 control-label">Behavior</label>
                                <div class="col-md-7">
                                	<input type="hidden" name="ID" value='' id="Behavior_id" />
                                    <input type="text" class="form-control" name="BehaviorName" id="BehaviorName" placeholder="Please Input Behavior" required/>
                                </div>
                            </div>
							<div class="form-group m-b-10">
							...
							<div class="col-md-7 col-md-offset-3">
                                <button type="submit" name="addBehavior" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
            ...
            <div class="form-group">
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong> Behavior Deleted.
                </div>
                </div>
                ...
                <div class="panel pagination-inverse m-b-0 clearfix">
                    <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        <thead>
                      	 ...
                      	 <tbody>
                         <cfoutput query="qgetBehavior" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                         	<tr class="inverse" id="remov_#ID#">
                                <td>#qgetBehavior.currentRow#</td>
                                <td id='cam-#id#'>#BehaviorName#</td>
								 <td>
									<cfif active eq 1 >
                                    Active
                                    <cfelse>
     ...
     <cfset qpagination = qgetBehavior >

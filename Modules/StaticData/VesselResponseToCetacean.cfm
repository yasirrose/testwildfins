...
<cfif isdefined('FORM.addVesselResponseToCetacean')>
<cfset qInsertVesselResponseToCetacean = Application.StaticDataNew.VesselResponseToCetaceanInsert(argumentCollection="#Form#")>
<cfif qInsertVesselResponseToCetacean.recordcount eq 1>
   <cfelse>
</cfif>
</cfif>
<cfif isdefined('FORM.editVesselResponseToCetacean')>
<cfset qEditVesselResponseToCetacean = Application.StaticDataNew.EditVesselResponseToCetacean(argumentCollection="#Form#")>
<cfif qEditVesselResponseToCetacean.recordcount eq 1>
   <cfelse>
</cfif>
</cfif>
<cfset qgetVesselResponseToCetacean = Application.StaticDataNew.getVesselResponseToCetacean()>
<cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset qgetVesselResponseToCetacean =Application.StaticDataNew.getVesselResponseToCetaceanByword(form.searchword)>
</cfif>
<!-- begin #content -->
<div id="content" class="content">
   ...
   <cfif isdefined('qInsertVesselResponseToCetacean') and qInsertVesselResponseToCetacean.recordcount eq 1 >
   <div class="alert alert-success fade in m-b-10" id="sucess-div">
            ...
            <cfoutput>
               <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-camara" method="post">
                  ...
                  <div class="col-md-7 col-md-offset-3">
                     <button type="submit" name="addVesselResponseToCetacean" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
   ...
   <div class="section-container section-with-top-border">
      ...
      <div class="panel pagination-inverse m-b-0 clearfix">
         <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
            ...
            <tbody>
               <cfoutput query="qgetVesselResponseToCetacean" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
         ...
         <cfset qpagination = qgetVesselResponseToCetacean>

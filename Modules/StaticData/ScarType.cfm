...
<cfif isdefined('FORM.addScarType')>
<cfset qInsertLesionType = Application.StaticDataNew.ScarTypeInsert(argumentCollection="#Form#")>
<!--- <cfif qInsertLesionType.recordcount eq 1>
   <cfelse>
</cfif> --->
</cfif>
<cfif isdefined('FORM.EditScarType')>
<cfset qEditScarType = Application.StaticDataNew.EditScarType(argumentCollection="#Form#")>
<cfif qEditScarType.recordcount eq 1>
   <cfelse>
</cfif>
</cfif>
<cfset qgetScarType = Application.StaticDataNew.getScarType()>
<cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetScarType=Application.StaticDataNew.getScarTypeByword(form.searchword)>
</cfif>
<!-- begin #content -->
<div id="content" class="content">
   ...
   <ol class="breadcrumb pull-right">
      ...
      <li><a href="javascript:;">Scar Type</a></li>
   </ol>
   <!-- end breadcrumb -->
   <!-- begin page-header -->
   <h1 class="page-header">Scar Type</h1>
   <!-- end page-header -->
   <cfif isdefined('qEditScarType') and qEditScarType.recordcount eq 1 >
   ...
   <cfif isdefined('qInsertLesionType') and qInsertLesionType.recordcount eq 1 >
   <div class="alert alert-success fade in m-b-10" id="sucess-div">
   ...
   <div class="section-container section-with-top-border p-b-10">
      <div class="row">
         <!-- begin col-6 -->
         <div class="col-md-10">
            <h5 class="m-t-0">Create ScarType Record</h5>
            <cfoutput>
               <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-camara" method="post">
                  <div class="form-group m-b-10">
                     <label class="col-md-3 control-label">Scar Type</label>
                     <div class="col-md-7">
                        <input type="hidden" name="ID" value='' id="LesionType_id" />
                        <input type="text" class="form-control" name="ScarTypeName" id="ScarTypeName" placeholder="Please Input Scar Type" required/>
                     </div>
                  </div>
                  <div class="form-group m-b-10">
                  ...
                  <div class="col-md-7 col-md-offset-3">
                     <button type="submit" name="addScarType" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
   ...
   <div class="form-group">
      <div class="alert alert-success message" style="display:none">
         <strong>Success!</strong> Scar Type Deleted.
      </div>
   </div>
   ...
   <div class="section-container section-with-top-border">
      ...
      <div class="panel pagination-inverse m-b-0 clearfix">
         <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
            ...
            <tbody>
               <cfoutput query="qgetScarType" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                  <tr class="inverse" id="remov_#ID#">
                     <td>#qgetScarType.currentRow#</td>
                     <td id='cam-#id#'>#ScarTypeName#</td>
                     <td>
                        <cfif active eq 1 >
                           Active
                           <cfelse>
         ...
         <cfset qpagination = qgetScarType >

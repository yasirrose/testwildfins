                                            ...
                                            <div class="col-sm-6 "> 
                                                <div class="form-group">
                                                    <label class="date-padd">Necropsy Date</label>
                                                        <div class="input-group date " id="datetimepicker_Date">
                                                            <input type="text" placeholder="mm/dd/yyyy" name="date123" id="date"
                                                                class="form-control" value='<cfif isDefined('qgetcetaceanDate.CNRDATE') and #qgetcetaceanDate.CNRDATE# neq "" >#DateTimeFormat(qgetcetaceanDate.CNRDATE, "MM/dd/YYYY")# </cfif>' readonly/>
                                                                <span class="input-group-addon time-icon"> <span class="glyphicon glyphicon-calendar"></span> </span>
                                                        </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="input-style xl-width" onblur="headerDataSave()" type="text" value="<cfif isDefined('qLCEDataa.lat')>#qLCEDataa.lat#</cfif>" name="lat" id="AtLatitude">
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="col-sm-6">
                                            <div class="form-group ">
                                                <div class="input-group">
                                                    ...
                                                    <input class="input-style xl-width" onblur="headerDataSave()" type="text" value="<cfif isDefined('qLCEDataa.lon')>#qLCEDataa.lon#</cfif>" name="lon" id="AtLongitude">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 heartrate-two">
                                        ...
                                        <div class="input-group">
                                            <div class="flex-center mb-1">
                                                ...
                                                <div class="input">
                                                    <input type="text" class="input input-style"  value="" id="respRate" placeholder="Resps /min">
                            ...
                            <label class="date-padd">Collection Date</label>
                                <div class="input-group date" id="collection_date_picker">
                                    <input type="text" placeholder="mm/dd/yyyy" name="collection_date" id="collection_date"
                                        class="form-control" value='#DateTimeFormat(qgetBloodValueData.Collection_Date, "MM/dd/YYYY")#'  />
                                        <span class="input-group-addon time-icon"> <span class="glyphicon glyphicon-calendar"></span> </span>
                                </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group blood-from-froup flex-center flex-wrap-wrap">
                            <label class="date-padd">Analysis Date</label>
                                <div class="input-group date " id="datetimepicker_Datee">
                                    <input type="text" placeholder="mm/dd/yyyy" name="Analysis_date" id="Analysis_date"
                                        class="form-control" value='#DateTimeFormat(qgetBloodValueData.Analysis_date, "MM/dd/YYYY")#'  />
                                        <span class="input-group-addon time-icon"> <span class="glyphicon glyphicon-calendar"></span> </span>
                                </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="simple-accession-table">
                                            <div class="responsive-tale">
                                                ...
                                                <table class="table table-bordered table-hover" id="AncillaryTable" >
                                                    <thead>
                                                        <tr>
                                                            <th>ID</th>
                                                            <th>Tissue Type</th>

...
<cfif permissions eq "full_access" or findNoCase("ST", permissions) neq 0>
    ...
    <cfif isDefined('SaveAndNew') OR isDefined('SaveandgotoAForm') OR isDefined('SaveAndClose')>
        ...
        <cfif  isDefined('form.ID') and form.ID neq "">
            <!--- <cfdump var="#url.LCE_ID#" abort="true"> --->
            ...
            <cfelseif isDefined('SaveandgotoAForm') and url.LCE_ID eq 0>
                <cfset form.LCE= form.ID>
                <cfset Application.Stranding.InsertHiExampData(argumentCollection="#Form#")>
                <cflocation addtoken="no" url="#Application.siteroot#?Module=Stranding&Page=LevelAForm" >
            </cfif>
            <cfset form.LCE= form.ID>
            <cfset Application.Stranding.InsertHiExampData(argumentCollection="#Form#")>
    ...
    <cfif url.LCE_ID neq 0>
        ...
        <!--- <cfdump var="#qgetHIData.affiliatedID#" abort="true">    --->
        <cfif #qgetHIData.species# neq "">
            <!--- <cfdump var="#qgetHIData.species#" abort="true"> --->
            ...
            <form id="myform" action="" method="post">
                                ...
                                <div class="HIForm-date-form form-group m-0 blue-bg-l">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 p-0">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"> 
                                                <div class="form-group flex-center">
                                                    <label class="date-padd">Necropsy Date
                                                    </label>
                                                        <div class="input-group date " id="datetimepicker_Date">
                                                            <input type="text" placeholder="mm/dd/yyyy" name="datew2efr" id="date"
                                    ...
                                    <div class="col-lg-12 col-md-12"> 
                                        <div class="form-group m-0">
                                            <div class="input-group flex-center">
                                                ...
                                                <div class="input">
                                                    <input class="input input-style" type="text" value="" name="AdditionalIdentifier" id="AdditionalIdentifier">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-6 col-xs-6">
                                        <div class="form-group">
                                            <div class="input-group flex-center">
                                                <label class="ageclass-label">Actual Class</label>
                                                <select class="form-control" name="actualeClass" id="ageClass">
                                                    <option value="">Select Age Class</option>
                                                    <!--- <cfloop from="1" to="#ArrayLen(ageClass)#" index="j">
                                                        <option value="#ageClass[j]#" <cfif #ageClass[j]# eq #qgetHIData.ageClass#>selected</cfif>>#ageClass[j]#</option>
                                                    </cfloop> --->
                ...
                <div class="row">
                    <div class="col-md-12" style="display: flex;">
                        <a type ="button" class="btn btn-primary" style="width: 10%; margin-right: 5px;"  href="http://test.wildfins.org/?Module=Stranding&Page=StrandingTabs">CetaceanExam</a>
                        <a type ="button" class="btn btn-primary" style="width: 10%; margin-right: 5px;" href="http://test.wildfins.org/?Module=Stranding&Page=HIForm">HIForm</a>
                        <!--- <a type ="button" class="btn btn-primary" style="width: 10%; margin-right: 5px;" href="http://test.wildfins.org/?Module=Stranding&Page=LevelAForm">Level A Form</a>
                        <a type ="button" class="btn btn-primary" style="width: 10%; margin-right: 5px;" href="http://test.wildfins.org/?Module=Stranding&Page=Histopathology">Histopathology</a>
                        <a type ="button" class="btn btn-primary" style="width: 10%; margin-right: 5px;" href="http://test.wildfins.org/?Module=Stranding&Page=BloodValues">Blood Values</a>
                        <a type ="button" class="btn btn-primary" style="width: 10%; margin-right: 5px;" href="http://test.wildfins.org/?Module=Stranding&Page=Toxicology">Toxicology</a>
                        <a type ="button" class="btn btn-primary" style="width: 10%; margin-right: 5px;" href="http://test.wildfins.org/?Module=Stranding&Page=AncillaryDiagnostics">Ancillary Diagnostics</a>
                        <a type ="button" class="btn btn-primary" style="width: 10%; margin-right: 5px;" href="http://test.wildfins.org/?Module=Stranding&Page=SampleArchive">Sample Archive</a>
                        <a type ="button" class="btn btn-primary" style="width: 10%; margin-right: 5px;" href="http://test.wildfins.org/?Module=Stranding&Page=CetaceanNecropsyReport">Cetacean Necropsy Report</a> --->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 ">
                                ...
                                <div class="form-group flex-center">
                                    ...
                                    <!--- <cfdump var="#qgetHIData.affiliatedID#" abort="true"> --->
                                    <input class="form-control"type="text" name="affiliatedID" value="#qgetHIData.affiliatedID#" maxlength="80">
                                </div>
                            </div> 
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"> 
                                    <div class="form-group flex-center">

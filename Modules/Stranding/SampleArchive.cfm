                                                ...
                                                <div class="form-group flex-center">
                                                    <label class="date-padd ceta-padd">Cetacean Exam Date</label>
                                                        <div class="input-group date " id="datetimepicker_Date">
                                                            <input type="text" placeholder="mm/dd/yyyy" name="cetaceanexamdate" id="date"
                                                                class="form-control" value='#DateTimeFormat(qgetcetaceanDate.date, "MM/dd/YYYY")#' readonly/>
                                                ...
                                                <div class="form-group flex-center">
                                                    <label class="date-padd necr-padd">Necropsy Date</label>
                                                        <div class="input-group date " id="datetimepicker_Date2">
                                                            <input type="text" placeholder="mm/dd/yyyy" name="necropsydate" id="necropsydate"
                                                                class="form-control" value='#DateTimeFormat(qgetcetaceanDate.CNRDATE, "MM/dd/YYYY")#' readonly/>
                                                                <span class="input-group-addon time-icon"> <span class="glyphicon glyphicon-calendar"></span> </span>
                                                        </div>
                                                </div>
                                            </div>

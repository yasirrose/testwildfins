...
<cfoutput>
    <div id="content" class="content">
        <div id="menu" style="left: 270px;">
            ...
            <input id="heat-map" name="flexRadioDefault" type="radio" class="ml-2" onclick="saveMapStyle('light-v10')" value="mapbox://styles/mapbox/satellite-v9" >
...
<script>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            .setHTML(
            `<h3><b>Title:</b>${mapSighting[i].properties.title}</h3><p><b>Date:</b>${mapSighting[i].properties.date}</p><p><b>Sighting Number:</b>${mapSighting[i].properties.sightingNo}</p> <a href="http://test.wildfins.org/?Module=Sighting&Page=Home&SurveyId=${mapSighting[i].properties.SurveyId}&SightingId=${mapSighting[i].properties.SightingId}">Open Sighting</a>`
            )
            )
            .addTo(map);
            }
...
//         new mapboxgl.Popup({ offset: 25 }) // add popups
//         .setHTML(
//         `<h3><b>Title:</b>${mapSighting[i].properties.title}</h3><p><b>Location:</b>${mapSighting[i].properties.description}</p><p><b>Location:</b>${mapSighting[i].properties.description}</p>`
//         )
//         )
//         .addTo(map);
//         }

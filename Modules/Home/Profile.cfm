                          ...
                          <div class="form-group m-b-10">
                           ...
                           <div class="form-group m-b-10">
                                ...
                                <label class="btn btn-default btn-file">
                               	 Browse <input type="file" value='' name="user_image" placeholder="" style="display: none;" onchange="readURL(this);" >
                                </label>
                                <img id="profile_image" src="" width="50" height="50"/ style="display:none;">
                                <cfif FileExists("#ExpandPath('.')#/assets/user_images/#SESSION["UserDetails"]["Id"]#/#SESSION["UserDetails"]["Id"]#.png")>
                                   <img src="#Application.superadmin#assets/user_images/#SESSION["UserDetails"]["Id"]#/#SESSION["UserDetails"]["Id"]#.png" alt="" width="50" height="50"/ id="current_profile_image">
                                </cfif>
                                </div>
                            </div>

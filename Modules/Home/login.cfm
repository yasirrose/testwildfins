<cfif isdefined('form.loginForm')>
    ...
    <!--- <cfdump var="#qGetSuperAdmin.user_password#"><cfabort> --->
    <cfif qGetSuperAdmin.RecordCount eq 1>
        <cfset sec = application.Sighting.getUserTypeSecuritySetting(#qGetSuperAdmin.user_type#)>
        <cfset update = Application.SuperAdminApp.updateloginTime(userid="#qGetSuperAdmin.user_id#")>
        ...
        <cfset SESSION["UserDetails"]["permissions"] = #sec["permissions"]#>
...
<cfif isdefined("form.forgetForm")>
	...
	<cfif emailcheck.RecordCount eq 1>
        ...
        <cfif updatepass.RecordCount eq 1>
            ...
            port="587"
            useTLS="Yes"
            username="tldz.dev1@gmail.com"
            password="P@sGFDGH!23456"
            ...
            <html>
                ...
                <body>
                    <div class="container">
                        ...
                        <p>Hello,</p>
                        <p>Your new login password is <strong>#pass#</strong></p>
               ...
               This Email Does Not Exist.
                 ...
                 <h6 class="text-center m-t-0 m-b-20">
              	 Forgot your password? No worries, enter your email address below and we will hook you up.
                    ...
                    <div class="text-center"><a href="##" id="go_forget">Reset Your Password</a>
                    </div>

    ...
    <cfoutput>
        ...
        <div class="col-lg-3">
            <div class="cust-row">
                ...
                <input type="text" id="birthday" name="birthday"  placeholder="mm/dd/yyyy"class="text-field"> 
            ...
            <div class="col-lg-5">
                <div class="cust-row">
                    ...
                    <div class="cust-inp input-group date"id="LevelA_Date">
                        <input type="text" id="Level_A_Date" name="LevelADate"  placeholder="mm/dd/yyyy"class="text-field"> 
                        <span class="input-group-addon time-icon"> <span class="glyphicon glyphicon-calendar"></span> </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <div class="cust-row">
                    ...
                    <div class="cust-inp input-group date"id="Necropsy_Date">
                        <input type="text" id="NecropsyDate" name="NecropsyDate"  placeholder="mm/dd/yyyy"class="text-field"> 
                        <span class="input-group-addon time-icon"> <span class="glyphicon glyphicon-calendar"></span> </span>
                    </div>
                </div>
            </div>

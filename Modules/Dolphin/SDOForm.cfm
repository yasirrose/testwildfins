        ...
        <div id="content" class="content">
			...
			<div class="col-md-4" style="border-right: solid 0.5px ##EEEEEE">
               ...
               <label for="sel1">Select Dolphin</label>
                ...
                <input type="text" class="form-control datepicker-sdo" name="PRES_LOBO_DATE" placeholder="MM/DD/YYYY" required >
                </div>
                ...
                <input type="text" class="form-control " name="Lobo_Confirmed" required >
                 ...
                 <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker-sdo" name="Recapture_Date_1" placeholder="MM/DD/YYYY" required >
                 </div>
                 
				<div class="form-group">
					<label for="email">Recapture Date 2:</label>
					<input type="text" class="form-control datepicker-sdo" name="Recapture_Date_2" placeholder="MM/DD/YYYY" required >
                </div>
                
                <div class="form-group">
                        <label for="email">Recapture Date 3:</label>
                        <input type="text" class="form-control datepicker-sdo" name="Recapture_Date_3" placeholder="MM/DD/YYYY" required ></div>
            ...
            <div class="col-md-4" style="border-right: solid 0.5px ##EEEEEE">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control datepicker-sdo" name="FB_on_Date" placeholder="MM/DD/YYYY" required >
                   </div>

                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div id="datetimepickerIR" class="input-group date col-lg-8 col-md-7 col-sm-12 col-xs-12">
                                        <input type="text" name="IR_Date" value=' <cfif isdefined('form.IR_ID')> #DateTimeFormat(qgetSingleIncidentReport.IR_Date, "MM/DD/YYYY")# </cfif>' placeholder="mm/dd/yyyy" class="form-control">

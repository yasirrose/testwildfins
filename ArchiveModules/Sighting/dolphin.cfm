                     ...
                     <!---</div>--->
                      ...
                      <!---</div>--->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">    
                        		<input type="text" class="form-control datetimepicker" value="#DateTimeFormat(project_detail.Date, 'MM/dd/YYYY')#" name="Dolphin_Sighting_Date" placeholder="MM/DD/YYYY" required >
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="label-wrap">
 	 ...
 	 <cfset total=d1total+d2total+d3total+d4total+d5total+d6total+d7total+d8total+d9total+d10total>
        ...
        <!---</div>--->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrap">    
                                    <input type="text" class="form-control datetimepicker" value="#DateTimeFormat(dolphine_sight.Dolphin_Sighting_Date, 'MM/dd/YYYY')#" name="Dolphin_Sighting_Date" placeholder="MM/DD/YYYY" required >
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="label-wrap">
                ...
                <div class="history_section">
                    <cfloop query="dolphine_sight" group="Code">
                        ...
                        <div class="row" id="sightingHistory_#i#">
                            <div class="col-md-12 panel-heading p-10 m-b-5" style="background:##ccc;">
                                <div class="col-md-2">#DateFormat(dolphine_sight.Dolphin_Sighting_Date, 'MM/DD/YYYY')#</div>

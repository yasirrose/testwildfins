              ...
              <strong>Success!</strong> #message#.
                ...
                <div class="col-lg-4">
                  <div class="form-group" >
                    ...
                    <div class="input-group  datetimepicker" data-date-start-date="Date.default" data-date-format="mm-dd-yyyy">					<input type="text" class="form-control datetimepicker" value="#DateFormat(getNCSG.Date_Entered,'mm/dd/yyyy')#" name="Date_Entered" id="datepicker-default" placeholder="mm-dd-yyyy" required  />		  <span class="input-group-addon"> 

...
<cfset qGetpreviouslyKnownDolphins = Application.Reporting.previouslyKnownDolphins(HearYear)>
...
<cfchart yaxistitle="% over artemis" format="png" chartheight="700" chartwidth="700" scalefrom="0" scaleto="#length#" title="Dolphins By Segment">
...
<cfelseif isDefined("FORM.Chart1")>
<cfif FORM.Chart1 eq "Download_chart_pdf">
<cfdocument format="pdf" name="HReport">
<cfchart yaxistitle="% over artemis" format="png" chartheight="700" chartwidth="700" title="Dolphins Released">
	<cfchartseries type="pie">
    	<cfchartdata item="Early" value="#qGetearlyReleasedDolphins.RecordCount#">
        <cfchartdata item="Late" value="#qGetlateReleasedDolphins.RecordCount#">
    </cfchartseries>
</cfchart>
</cfdocument>
<cfpdf action="WRITE" source="HReport" destination="#Application.DirectoryRoot#PDF\HERA\DolphinsReleased.pdf" overwrite="yes"/>
<cfhttp url="#Application.DirectoryRoot#PDF\HERA\DolphinsReleased.pdf" method="get" getAsBinary="yes" file="DolphinsReleased.pdf"/>
<cfheader name="Content-Disposition" value="attachment; filename=DolphinsReleased.pdf" />
<cfcontent type="application/pdf" file="#Application.DirectoryRoot#PDF\HERA\DolphinsReleased.pdf" />

<cfelseif FORM.Chart1 eq "Download_chart_jpg">
<cfchart name="myGraph" yaxistitle="% over artemis" format="jpg" chartheight="700" chartwidth="700" title="Dolphins Released">
	<cfchartseries type="pie">
    	<cfchartdata item="Early" value="#qGetearlyReleasedDolphins.RecordCount#">
        <cfchartdata item="Late" value="#qGetlateReleasedDolphins.RecordCount#">
    </cfchartseries>
</cfchart>
<cffile action="WRITE" file="#Application.DirectoryRoot#Graphs\HERA\DolphinsReleased.jpg" output="#MyGraph#"> 
<cflocation url="/Graphs/HERA/DolphinsReleased.jpg" addtoken="no">
</cfif>
</cfif>
	<cfoutput>
    <!-- begin ##content -->
		    ...
		    <div class="row col-lg-12">
		        ...
		        <div class="panel panel-inverse">
		            ...
		            <div class="panel-body">
                        ...
                        <div class="col-md-4" style="margin-bottom:10px;margin-top:6%; margin-left:34%;">
                        <!-- begin widget -->
                        <div class="widget widget-stat bg-success text-white">
                            ...
                            <div class="widget-stat-info">
                                <div class="widget-stat-title">Previously Known Dolphins</div>
                                <div class="widget-stat-number">#qGetpreviouslyKnownDolphins.RecordCount#</div>
                            </div>
                        </div>
                        <!-- end widget -->
                    </div>
                        <div class="col-md-4" style="margin-bottom:10px;margin-top:-14%; margin-left:1%;">
                        <!-- begin widget -->
                        <div class="widget widget-stat bg-success text-white">
                            <div class="widget-stat-icon"><img src="#Application.superadminTemplateIncludes#img/dashboard-icons/dolphin_sighted.png" height="60" width="60"></div>
                            <div class="widget-stat-info">
  ...
  <div class="modal-dialog" role="document" style="width:55%">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table  class="table table-striped table-bordered" >
                ...
                <td width="250"><b>Causes</b></td>
                <td width="50"><b>Release Date</b></td>
            </tr>
         </table>
         <div class="datacontainer"> 
         <table class="table table-striped table-bordered">  
           <cfloop query="#qGetearlyReleasedDolphins#">
            <cfoutput>
            	<tr>
                   <td width="100">#qGetearlyReleasedDolphins.Code#</td>
                  <td width="120">#qGetearlyReleasedDolphins.Name#</td>
                    <td width="250">#qGetearlyReleasedDolphins.Note#</td>
                   <td width="50">#qGetearlyReleasedDolphins.Date_Entered#</td>
                </tr>
              </cfoutput>  
            </cfloop>
        </table>
	...
	<!-- End Of Early Release Dolphins --->
    <!-- Late Release Dolphins --->
    	<div class="modal fade" id="lateReleasesDiv">
  <div class="modal-dialog" role="document" style="width:55%">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <h4 class="modal-title">Late Releases Dolphins</h4>
      </div>
      <div class="modal-body">
        <table  class="table table-striped table-bordered" >
                <tr>
                <td width="100"><b>Code</b></td>
                <td width="120"><b>Name</b></td>
                <td width="250"><b>Sex</b></td>
                <td width="50"><b>Release Date</b></td>
            </tr>
         </table>
         <div class="datacontainer"> 
         <table class="table table-striped table-bordered">  
           <cfloop query="#qGetlateReleasedDolphins#">
            <cfoutput>
            	<tr>
                   <td width="100">#qGetlateReleasedDolphins.Code#</td>
                  <td width="120">#qGetlateReleasedDolphins.Name#</td>
                    <td width="250">#qGetlateReleasedDolphins.Sex#</td>
                   <td width="50">#qGetlateReleasedDolphins.Date_Entered#</td>
                </tr>
              </cfoutput>  
            </cfloop>
        </table>

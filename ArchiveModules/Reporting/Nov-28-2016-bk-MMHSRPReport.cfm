...
<cfset qGetDeadDolphins = Application.Reporting.DeadDolphins(appendyear)>
...
<cfset qgetBodyConditionGrapgh = Application.Reporting.deadBodyConditions(deadConditionStartYear, deadConditionEndYear)>
...
<cfset qGetDeadDolphinsByMonth = Application.Reporting.DeadDolphinsByMonth(i, filterMonthlyYear)>
...
<cfset qGetAgeSexCohort = Application.Reporting.AgeSexCohort(cohortSex, SearchingAge)>
<cfelse>
<cfset qGetAgeSexCohort.RecordCount = 0>
</cfif>
<!--- Freez-Brand Recovered Dead --->
<cfset qGetfreezbrandRecovered = Application.Reporting.freezbrandRecovered()>
<script>
    <cfoutput>
			    ...
			    <div class="row col-lg-12">
			        ...
			        <div class="panel panel-inverse">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                  ...
                                  <select class="form-control" name="cohortEndYear" id="cohortEndYear" style="width: 120%;">
                                    <cfloop to='#ReportEndyear#' from="#ReportStartyear#" index="i">
                        ...
                        <div class="col-md-8" style="margin-bottom:10px;margin-top:-4%; margin-left:31%;">
                        <!-- begin widget -->
                    ...
                    <!-- End  col-6-->
                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-8" style="margin-bottom:10px;margin-top:10%; margin-left:31%;">
                        <!-- begin widget -->
                        <div class="widget widget-stat bg-success text-white">
                            <div class="widget-stat-icon"><img src="#Application.superadminTemplateIncludes#img/dashboard-icons/dolphin_sighted.png" height="60" width="60"></div>
                            <div class="widget-stat-info">
                    ...
                    <!-- End  col-6-->
                      ...
                      <div class="panel-body">
                        ...
                        <div>
                          	<canvas id="pie-chart2" style="margin-top:2%;"></canvas><br />
                		 	<div id="legend2"></div>   
                        </div>
                      </div>
                    </div>    

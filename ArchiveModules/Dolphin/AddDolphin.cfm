			...
			<cfoutput>
               <form role="form" id="add_dolphinto_dolhpin" enctype="multipart/form-data">	 
				...
				<input type="text" class="form-control" name="Code" required >
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control datepicker_addDol" name="DistinctDate" placeholder="MM/DD/YYYY" required >
				  </div>
                  ...
                  <div class="form-group">
					...
					<input type="text" class="form-control datepicker_addDol" name="Date_of_Death" placeholder="MM/DD/YYYY" required >
                  </div>
              ...
              <div class="col-md-4" style="border-right: solid 0.5px ##EEEEEE">
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control datepicker_addDol"  name="Date_of_Birth_EST" placeholder="MM/DD/YYYY"  required >
            	</div>
                
                <div class="form-group">
					<label for="email">Dispersal Date:</label>
					<input type="text" class="form-control datepicker_addDol" name="Dispersal_Date" placeholder="MM/DD/YYYY"  required >
            	</div>
                ...
                <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker_addDol" name="First_Sighting_Date" placeholder="MM/DD/YYYY" required >
                 </div>

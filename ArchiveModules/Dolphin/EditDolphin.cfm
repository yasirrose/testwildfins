...
<cfelse>
<cflocation url="#Application.superadmin#?ArchiveModule=Dolphin&Page=ListDolphin&Archive" addtoken="no"> 
</cfif>
		...
		<div id="content" class="content">
            ...
            <div class="right-button-box right-button-box-holder text-right">
                <ul class="scroe-bttn">
                      ...
                      <li> <form action="#Application.superadmin#?ArchiveModule=Dolphin&Page=DolphinHistory&Archive" method="post">
               ...
               <form role="form" id="update_dolphinto_dolhpin" enctype="multipart/form-data">	 
				...
				<input type="text" class="form-control" name="Code" value="#getdolphin.Code#"  >
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control datetimepicker" name="DistinctDate" value="#DateFormat(getdolphin.DistinctDate,"mm/dd/yyyy")#" placeholder="MM/DD/YYYY"  >
				  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
					...
					<input type="text" class="form-control datetimepicker" name="Date_of_Death" value="#DateFormat(getdolphin.DateofDeath,"mm/dd/yyyy")#" placeholder="MM/DD/YYYY"  >
                  </div>
            ...
            <div class="col-md-4" style="border-right: solid 0.5px ##EEEEEE">
               ...
               <input type="text" class="form-control" id="datetimepickerEST" name="Date_of_Birth_EST" <cfif getdolphin.DateofBirthEST eq 'CNBD'> value="" <cfelse> value="#DateFormat(getdolphin.DateofBirthEST,"mm/yyyy")#" </cfif> >
                ...
                <div class="form-group">
					...
					<input type="text" class="form-control datetimepicker" name="Dispersal_Date" value="#DateFormat(getdolphin.DispersalDate,"mm/dd/yyyy")#"   >
            	</div>
                   ...
                   <label for="email">Catalog:</label>
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control datetimepicker" name="First_Sighting_Date" value="#DATEFORMAT(getdolphin.FirstSightingDate,"mm/dd/yyyy")#" placeholder="MM/DD/YYYY"  >
                     </div>
                        ...
                        <thead>
                            ...
                            <cfloop query="getMMHSRP_Dophin">
                         	<tr id="remov_#ID#" class="inverse">
								...
								<td>#DateFormat(getMMHSRP_Dophin.Date,"mm/dd/yyyy")#</td>

...
<cfif isdefined('FORM.addDscore')>
    <cfset qInsertaddDscore = Application.StaticData.addDscoreInsert(argumentCollection="#Form#")>
     <cfelse>
    </cfif>

<cfif isdefined('FORM.editDscore')>

    <cfset EditDscore = Application.StaticData.EditDscore(argumentCollection="#Form#")>
   <cfelse>
    </cfif>
<cfset getDscore = Application.StaticData.getDscore()>
<div id="content" class="content">
    <ol class="breadcrumb pull-right">
        <li><a href="javascript:;">Home</a></li>
        <li><a href="javascript:;">Dscore</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Dscore</h1>
...
<div class="row">
    <!-- begin col-6 -->
<div class="col-md-10">
    <h5 class="m-t-0">Create Dscore Record</h5>
<cfoutput>
        ...
        <div class="form-group m-b-10">
            ...
            <div class="col-md-7">
                <input type="hidden" name="ID" value='' id="dscore_id" />
                <input type="text" class="form-control" name="addscore" id="addscoreID" placeholder="please input Dscore" required/>
            </div>
        </div>
        <div class="form-group m-b-10">
        ...
        <div class="col-md-7 col-md-offset-3">
            <button type="submit" name="addDscore" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
...
<tbody>
<cfoutput query="getDscore" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
    <tr class="inverse" id="remov_#ID#">
<td>#getDscore.currentRow#</td>
        <td id='cam-#ID#'>#Dscore#</td>
<td>
    <cfif active eq 1 >
            Active
    <cfelse>

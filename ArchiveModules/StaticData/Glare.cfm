...
<cfif isdefined('FORM.addGlare')>
    <cfset qInsertGlare = Application.StaticData.GlareInsert(argumentCollection="#Form#")>
    <cfif qInsertGlare.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>

<cfif isdefined('FORM.editGlare')>
    <cfset qEditGlare = Application.StaticData.EditGlare(argumentCollection="#Form#")>
    <cfif qEditGlare.recordcount eq 1>
    <cfelse>
    </cfif>
</cfif>
 <cfset qgetGlare = Application.StaticData.getGlare()>

 
<cfif isdefined("form") and len(trim(form.searchword)) NEQ 0>
<cfset   qgetGlare=Application.StaticData.getGlareByword(form.searchword)>
</cfif>
		<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Glare</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Glare</h1>
			<!-- end page-header -->
			<cfif isdefined('qEditGlare') and qEditGlare.recordcount eq 1 >
				   ...
				   <cfif isdefined('qInsertGlare') and qInsertGlare.recordcount eq 1 >
                    <div class="alert alert-success fade in m-b-10" id="sucess-div">
			...
			<div class="row">
                    <!-- begin col-6 -->
                    <div class="col-md-10">
                        <h5 class="m-t-0">Create Glare Record</h5>
                  
                     <cfoutput>
                        <form class="form-horizontal" action="#CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#" name="add-camara" method="post">
                            <div class="form-group m-b-10">
                                <label class="col-md-3 control-label">Glare</label>
                                <div class="col-md-7">
                                	 <input type="hidden" name="ID" value='' id="Glare_id" />
                      <input type="text" class="form-control" name="DESC" id="GlareName" placeholder="please input Glare" required/>
                                </div>
                            </div>
							<div class="form-group m-b-10">
       ...
       <button type="submit" name="addGlare" value ="submit" class="btn btn-success width-100 m-r-5" id="add">Submit</button>
            ...
            <div class="form-group">
                <div class="alert alert-success message" style="display:none">
                  <strong>Success!</strong> Glare Deleted.
                </div>
                </div>
                ...
                <div class="panel pagination-inverse m-b-0 clearfix">
                    <table id="example" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        <thead>
                      	 ...
                      	 <tbody>
                         <cfoutput query="qgetGlare" startrow="#startHereIndex#" maxrows="#Application.record_per_page#">
                         	<tr class="inverse" id="remov_#ID#">
                                <td>#qgetGlare.currentRow#</td>

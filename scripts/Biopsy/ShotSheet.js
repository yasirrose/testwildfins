...
function forestshotdata(ShotNum,id) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#preMill').val(rep[0]["TABPre_Activity_Mill"]);
            $('#prefeed').val(rep[0]["TABPre_Activity_Feed"]);
            $('#prebfeed').val(rep[0]["TABPre_Activity_ProbFeed"]);
            $('#pretravel').val(rep[0]["TABPre_Activity_Travel"]);
            $('#preplay').val(rep[0]["TABPre_Activity_Play"]);
            $('#prerest').val(rep[0]["TABPre_ACTIVITY_REST"]);
            $('#prechuff').val(rep[0]["TABPre_Activity_Leap_tailslap_chuff"]);
            $('#presocial').val(rep[0]["TABPre_Activity_Social"]);
            $('#preboat').val(rep[0]["TABPre_ACTIVITY_WITHBOAT"]);
            $('#preother').val(rep[0]["TABPre_Activity_Other"]);
            $('#preavoid').val(rep[0]["TABPre_Activity_Avoid_Boat"]);
            $('#predepredation').val(rep[0]["TABPre_Depredation"]);
            $('#preherding').val(rep[0]["TABPre_Herding"]);
            $('#groupmill').val(rep[0]["GBPre_Activity_Mill"]);
            $('#groupfeed').val(rep[0]["GBPre_Activity_Feed"]);
            $('#groupbfeed').val(rep[0]["GBPre_Activity_ProbFeed"]);
            $('#grouptravel').val(rep[0]["GBPre_Activity_Travel"]);
            $('#groupplay').val(rep[0]["GBPre_Activity_Play"]);
            $('#grouprest').val(rep[0]["GBPre_ACTIVITY_REST"]);
            $('#groupchuff').val(rep[0]["GBPre_Activity_Leap_tailslap_chuff"]);
            $('#groupsocial').val(rep[0]["GBPre_Activity_Social"]);
            $('#groupboat').val(rep[0]["GBPre_ACTIVITY_WITHBOAT"]);
            $('#groupother').val(rep[0]["GBPre_Activity_Other"]);
            $('#groupavoid').val(rep[0]["GBPre_Activity_Avoid_Boat"]);
            $('#groupdepredation').val(rep[0]["GBPre_Depredation"]);
            $('#groupherding').val(rep[0]["GBPre_Herding"]);
            $('#postmill').val(rep[0]["TABPost_Activity_Mill"]);
            $('#postfeed').val(rep[0]["TABPost_Activity_Feed"]);
            $('#postbfeed').val(rep[0]["TABPost_Activity_ProbFeed"]);
            $('#posttravel').val(rep[0]["TABPost_Activity_Travel"]);
            $('#postplay').val(rep[0]["TABPost_Activity_Play"]);
            $('#postrest').val(rep[0]["TABPost_ACTIVITY_REST"]);
            $('#postchuff').val(rep[0]["TABPost_Activity_Leap_tailslap_chuff"]);
            $('#postsocial').val(rep[0]["TABPost_Activity_Social"]);
            $('#postboat').val(rep[0]["TABPost_ACTIVITY_WITHBOAT"]);
            $('#postother').val(rep[0]["TABPost_Activity_Other"]);
            $('#postavoid').val(rep[0]["TABPost_Activity_Avoid_Boat"]);
            $('#postdepredation').val(rep[0]["TABPost_Depredation"]);
            $('#postherding').val(rep[0]["TABPost_Herding"]);
            $('#gpmill').val(rep[0]["GBPost_Activity_Mill"]);
            $('#gpfeed').val(rep[0]["GBPost_Activity_Feed"]);
            $('#gpbfeed').val(rep[0]["GBPost_Activity_ProbFeed"]);
            $('#gptravel').val(rep[0]["GBPost_Activity_Travel"]);
            $('#gpplay').val(rep[0]["GBPost_Activity_Play"]);
            $('#gprest').val(rep[0]["GBPost_ACTIVITY_REST"]);
            $('#gpchuff').val(rep[0]["GBPost_Activity_Leap_tailslap_chuff"]);
            $('#gpsocial').val(rep[0]["GBPost_Activity_Social"]);
            $('#gpwithboat').val(rep[0]["GBPost_ACTIVITY_WITHBOAT"]);
            $('#gpother').val(rep[0]["GBPost_Activity_Other"]);
            $('#gpboat').val(rep[0]["GBPost_Activity_Avoid_Boat"]);
            $('#gpdepredation').val(rep[0]["GBPost_Depredation"]);
            $('#gppostherding').val(rep[0]["GBPost_Herding"]);

function deleteRecord(id) {
	...
	if (result == true) {
	$.ajax({
		url:application_root+"StaticDataNew.cfc?method=DeleteGlareDirection",
		type : "get",
		data : {id : id},
...
function updateRecord(id) {
	...
	$('#GlareDirectionName').val($('#cam-'+id).text());
	$("#add").attr('name', 'editGlareDirection');
	$("#add").text('Edit');
	$("#GlareDirection_id").val(id);

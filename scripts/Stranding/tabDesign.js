...
function newToxi(){
  ...
  $( "#Toxi" ).append('<div class="row toxi-rw" id="toxi_'+count+'"><div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 blood-column"><input type="text" placeholder="Toxin" value="" name="toxi_label" id="toxi_label" required><input class="toxi-field" type="text" maxlength="8" value="" name="toxi_type" id="toxi_type" required><span>ug/g dry</span></div><div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 blood-column"><label >Reference Range</label><input class="toxi-field" type="text" maxlength="8" value="" name="toxi_range"  id="toxi_range" required><span>ug/g dry</span></div><div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 blood-column"><label class="t-cust-l">Sample Result</label><select name="toxi_report" id="toxi_report" ><option value="High">High</option><option value="Low">Low</option><option value="Critical Result">Critical Result</option><option value="Corrected">Corrected</option><option value="None">None</option></select></div><br/><span class="remove" id="toxi_'+count+'" onclick="removeToxiDiv(this)">Remove</span></span></div>');
